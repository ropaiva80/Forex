...
call "C:\Users\ropai\anaconda3\Scripts\activate.bat" Python3.7_Env-GluonTS_off_1h_simple & cd "C:\Python\Crypto\Day_Trading\1H" & python Script_Report_BTC_1H_Datetimes1H_AGO_ML.py