...
Df = yf.download('USDJPY=X', start_date, today, interval='1M', auto_adjust=True)
...
# Collect data from Yahoo (hourly)
data = yf.download('USDJPY=X', start_date, today, interval='1M', auto_adjust=True)
...
print ("CAUTION: Timezone -07:00 - UTC - Prediction 5Min ahead")
clock = datetime.now()
